...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.apiconfig.testingsupport.repository..*.*(..))")
  public void repository() {
    // all repository methods
  }

  @Pointcut("execution(* it.gov.pagopa.apiconfig.testingsupport.service..*.*(..))")
  public void service() {
    // all service methods
  }

  @Pointcut("execution(* it.gov.pagopa.apiconfig.testingsupport.exception.ErrorHandler.*(..))")
